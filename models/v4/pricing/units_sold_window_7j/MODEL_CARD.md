# Model card — pricing V4 — units_sold_window_7j
...
WAPE macro (moyenne des 6 fenetres) : 0.1342
Biais moyen : +0.0054

Cible : `units_sold_window_7j`. Grain : une decision de tarification hebdomadaire par produit.
