# Model card — pricing V4 — revenue_window_xof_7j
...
WAPE macro (moyenne des 6 fenetres) : 0.1299
Biais moyen : +0.0020

Cible : `revenue_window_xof_7j`. Grain : une decision de tarification hebdomadaire par produit.
